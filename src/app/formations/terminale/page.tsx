      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-4">
                Orientation et Études Supérieures
              </h2>
              <p className="text-xl text-slate-600">
                Un accompagnement complet pour réussir votre transition vers le supérieur
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black">Parcoursup</h3>
                </div>
                <p className="text-gray-700 mb-4">
                  Accompagnement personnalisé dans vos choix d'orientation
                </p>
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Aide à la rédaction des projets motivés</li>
                  <li>• Simulation d'entretiens</li>
                  <li>• Analyse des attendus des formations</li>
                </ul>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black">Cordées de la Réussite</h3>
                </div>
                <p className="text-gray-700 mb-4">
                  Partenariats avec les grandes écoles et universités
                </p>
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Tutorat par des étudiants</li>
                  <li>• Visites d'établissements</li>
                  <li>• Préparation aux concours</li>
                </ul>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black">International</h3>
                </div>
                <p className="text-gray-700 mb-4">
                  Ouverture vers l'international et les études à l'étranger
                </p>
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Programmes d'échanges</li>
                  <li>• Certifications linguistiques</li>
                  <li>• Aide aux candidatures internationales</li>
                </ul>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black">Classes Préparatoires</h3>
                </div>
                <p className="text-gray-700 mb-4">
                  Préparation aux concours des grandes écoles
                </p>
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Stages de préparation</li>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black">Universités</h3>
                </div>
                <p className="text-gray-700 mb-4">
                  Préparation aux études universitaires
                </p>
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Immersion dans les facs partenaires</li>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-black">Écoles Spécialisées</h3>
                </div>
                <p className="text-gray-700 mb-4">
                  Accompagnement vers les écoles spécialisées
                </p>
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Commerce, ingénierie, santé</li>
                  <li>• Arts, communication, design</li>
                  <li>• Préparation aux concours spécifiques</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6">
              Prêt pour l'excellence en Terminale ?
            </h2>
            <p className="text-xl mb-8 text-purple-100">
              Rejoignez notre classe de Terminale pour décrocher votre baccalauréat avec mention et réussir votre projet post-bac
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/inscriptions"
